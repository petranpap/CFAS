...
<div class="login-box">
  ...
  <div class="login-logo">
    <a href="/">
<img alt="CFAS logo" src="../cfas_logo.png">
</a>
<h1>Cyber Safety Family Advice Suite</h1>
<h2>Γονική Κονσόλα</h2>
  </div>
  <!-- /.login-log -->
...
<form action="" method="post" id="frmLogin">
 ...
 <div class="field-group">
    <div><input type="submit" name="login" value="Σύνδεση" class="form-submit-button btn btn-primary btn-block btn-flat"style=" background: blue; "></span></div>
  </div>
</form>
<br><br>

<div id="myDIV">
    <div><label for="login">Επιλογή Γλώσσας</label></div>
  <button onClick="englishURL();" class="btn" value="en">
...
<use xlink:href="#s5" x="2470"/>
 ...
 <a href="https://encase-proxy.socialcomputing.eu:8090/el/index.php"> <button onClick="window.location.reload();" class="btn active" value="el">
<?xml version="1.0" encoding="UTF-8"?>
...
for (var i = 0; i < btns.length; i++) {
  ...
  this.className += " active";
    ...
    <a href="#">Ξεχάσατε τον κωδικό σας;</a><br>
    <a href="/el/register.php" class="text-center">Δημιουργία Λογαριασμού</a>
...
<div class="member-dashboard">Καλωσόρισατε <b><?php echo ucwords($json['parent_first_name'])." ".ucwords($json['parent_last_name']); ?></b>, Έχετε συνδεθεί επιτυχώς!<br><br>
Πατήστε το κουμπί <input type="submit" name="logout" value="Αποσύνδεση" class="logout-button"><br><br>
Ή πηγαίνεται στη <a href="/el/home.php">
      <i class="fa fa-dashboard"></i> <span>Γονική κονσόλα CFAS</span>
...
<script>
        ...
        window.location = newURL.replace('/el', '/en');
 }
</script>
</body>
</html>
