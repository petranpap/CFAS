...
<div class="container">
	...
	<h1> CFAS Cybersafety Education </h1>
            <p>Welcome to the CFAS Cybersafety Education page!</p>
<p>Here, we offer a range of digital materials and software designed to facilitate cybersafety courses for your classroom.</p>
<p>Before you begin utilizing CFAS Cybersafety Education with your students, we strongly recommend downloading and thoroughly reviewing the comprehensive <a href="https://www.concordia-h2020.eu/wp-content/uploads/2022/11/Teach-the-TeachersMethodology-for-publication.pdf" target="_blank">Concordia guidelines for teaching cybersafety</a>.</p>
<p><i>Our educational features are built upon the>cybersafety educational content developed through the support of the EU-funded <a href="https://www.concordia-h2020.eu/" target="_blank">Concordia project </a>(Grant No. 830927).</i></p>
        </div>
        <div class="buttons">
            ...
            <button class="button " onclick="openAssignCoursesModal()">Assign Courses</button>
 ...
 <tr>
                    ...
                    <label for="Course1"></label>
                        <svg xmlns="http://www.w3.org/2000/svg" style="display: none">
                            ...
                            <path stroke-linecap="round" stroke-miterlimit="10" fill="none" d="M22.9 3.7l-15.2 16.6-6.6-7.1">
                                ...
                                <td><a href="https://proxyencase.cut.ac.cy:8090/courses/A1-I.html">A1. Personal / Sensitive Data and Privacy - Intermediate</a></td>
                                <td>Levels 1</td>
                <td><input type="file" accept="*"></td>
                            ...
                            <tr>
                                ...
                                <td><a href="https://proxyencase.cut.ac.cy:8090/courses/A1-F.html">A1. Personal / Sensitive Data and Privacy</a></td>
                                <td>Levels 2</td>
                <td><input type="file" accept="*"></td>
                            </tr>
<tr>
                                ...
                                <td><a href="https://proxyencase.cut.ac.cy:8090/courses/A2-F.html">A2. Cyberbullying and Sexual Harassment-Foundation</a></td>
                                <td>Levels 2</td>
                <td><input type="file" accept="*"></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><a href="https://proxyencase.cut.ac.cy:8090/courses/A3-F.html">A3. Inappropriate Content - Foundation</a></td>
                                <td>Levels 2</td>
                <td><input type="file" accept="*"></td>
                            </tr>
                        </table>
