...
<form method="post" action="<?php echo $variable_for_actionform; ?>" >
        ...
        <?php 
$count = 0; // Counter variable to track the number of iterations

foreach ($questions as $question): 
if ($count >= 3) { // Check if the counter has reached the limit
        break; // Exit the loop if the limit is reached
    }
?>

                <div class="quiz-options_<?php echo $question['id']; ?>">
                <p style="color: white;font-size:larger">Question 1: <span style="text-decoration:underline"><?php echo $question['question_text']; ?></span></p>
                <?php
        ...
        <?php
    $count++; // Increment the counter variable after each iteration
