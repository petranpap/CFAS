  ...
  <div id="content">
	...
	<div style=" height:150px; margin-bottom:10%;" class="center">
		...
		<div id="avatar_text" style="width: 75%; float: left;">
			<h5>Hello! From this page you can see all the Cybersafety Family Advice Suite's notifications!</h5>
			<p>From the left menu, you can choose for which online social network (Facebook or Twitter), you want to see the notifications!</p>
		</div>
	</div>
...
<!--     Notification list container/box -->
	...
	<div id="facebook" class="list-group">
          <div class="notification_title"><h5>Facebook Notifications</h5></div>
	  <button class="bt1" id="toggle-collapse-fb">Show more notifications</button>
        </div>
        
	<div id="twitter" class="list-group">
	<div class="notification_title"><h5>Twitter Notifications</h5></div>
	<button class="bt2" id="toggle-collapse-tw">Show more notifications</button>
        </div>
       </div>
    </div>
