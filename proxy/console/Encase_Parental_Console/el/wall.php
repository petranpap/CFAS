...
?>
	...
	<!-- Content Wrapper. Contains page content -->
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    <?php echo 'Ο τοίχος του Facebook του/της '. $json_child['child_first_name'] ?>

                </h1>
                <ol class="breadcrumb">
                    <li><a href="home.php"><i class="fa fa-dashboard"></i>Αρχική Σελίδα</a></li>
                    <li class="active">Τοίχος</li>
                </ol>
            </section>
 ...
 <?php include('rightsidebar.php');?>
      ...
      // End of Check if the father can see the Wall !
            ...
            echo ' <!-- Left col --><section class="col-lg-7 connectedSortable">Ο/Η '.$json_child['child_first_name'].' δεν έχει συμφωνήσει για να μπορείτε να δείτε τον "τοίχο" του</section>';
