...
?>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                   Βοηθήστε το Cyber Safety Family Advice Suite να εντοπίσει τον/την <?php echo $json_child["child_first_name"] ?></h1>
<h1> στα Διαδικτυακά Κοινωνικά Μέσα
                </h1>
                <ol class="breadcrumb">
                    <li><a href="home.php"><i class="fa fa-dashboard"></i> Αρχική Σελίδα</a></li>
                    <li class="active">Εκπαίδευση με εικόνες</li>
                </ol>
            </section>
    ...
    <form enctype="multipart/form-data" action="" method="post">
                    <p>Το Cyber Safety Family Advice Suite είναι σε θέση να εντοπίζει πότε ο/η <?php echo $json_child["child_first_name"] ?> ανεβάζει εικόνα στα Διαδικτυακά Κοινωνικά Μέσα.</p>
                    <p>Για να ενεργοποιήσετε αυτό το χαρακτηριστικό, θα πρέπει να ανεβάσετε περίπου 12 εικόνες του/της <?php echo $json_child["child_first_name"]?> χρησιμοποιώντας το κουμπί "<i>Choose file</i>" που ακολουθεί.
                       Έπειτα, χρησιμοποιήστε το κουμπί "<i>Add More Files</i>"  για να ανεβάσετε κι άλλες εικόνες του/της <?php echo $json_child["child_first_name"] ?>.</p>
                    <p>Παρακαλώ σιγουρευτείτε ότι το πρόσωπο του/της <?php echo $json_child["child_first_name"] ?> εμφανίζεται ξεκάθαρα στην εικόνα και ότι η εικόνα είναι υψηλής ποιότητας.</p>
                    <hr/>
                    <div id="filediv"><input name="file[]" value="Ανέβασμα Αρχείου" type="file" id="file"/></div><br/>

                    <input type="button" id="add_more" class="upload" value="Προσθήκη περισσότερων Αρχείων"/>
                    <input type="submit" value="Ανέβασμα Αρχείων" name="submit" id="upload" class="upload"/>
                </form>
                <?php
                $images_array=array();
