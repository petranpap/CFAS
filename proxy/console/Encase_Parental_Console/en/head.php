        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="/en/home.php" class="logo" style="background:white;color:#222d32;padding-left: 0pt;">
                    ...
                    <span class="logo-mini"><b>Parental</b>Console</span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><img src="../cfas_logo_no_letters.png"><b style="padding-left:3pt;">Parental</b>Console</span>
                </a>
                        ...
                        <ul class="nav navbar-nav">
                                ...
                                <span id="warning" class="label label-warning"></span>
                                        ...
                                        <ul class="dropdown-menu" style="width: 95em;">
                                            <li id="notify_header" class="header" style="border-bottom: 1px solid black;">Notifications</li>
