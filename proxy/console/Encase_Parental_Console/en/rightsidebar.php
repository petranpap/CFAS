...
<section class="col-lg-5 connectedSortable" style="float: right;">
	...
	<div class="box box-info">
		<div class="box-header">
			...
			<h3 class="box-title">Quick Flag<?php if (isset($_SESSION["parent_id"])) {
 ...
 ?></h3>
		...
		<div class="box-body">
			<form action="#" method="post">
				...
				<div class="form-group">
					<p>Flag For : 	<select id="flag" name="flag" class="selectpicker"  multiple title="Choose one of the following...">
						<option value="sexualgrooming">Sexual Grooming</option>
						<option value="hatespeech">Hate or Inappropriate Speech</option>
						<option value="cyberbullying">Cyber Bullying</option>
						<option value="distressedbehavior">Distressed Behavior</option>
					</select></p>
					<!-- <input type="text" class="form-control" name="subject" placeholder="Subject"> -->
				
				</div>
				<div><input type="text" class="form-control" id="from" name="from" placeholder="From"></div><br>
				<div>
