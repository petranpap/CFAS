...
<div class="container mt-5">
  ...
  <div class="card">
    ...
    <div id="info" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample" style="">
      <div class="card-body">
       <p>If you upload a picture, Cyber Safety Family Advice Suite automatically protects it with encryption.<br>
          From <b>Preview</b> tab you can find the list of the accounts that can see your picture, whoever is not in the list, they can not see your uploaded picture.<br>
          From the <b>Edit</b> tab, you can edit the list by adding/removing an account using his/her Facebook URL.</p><img src="../../images/get_fb_url.jpg" style="width: 90%">
      </div>
    </div>
  </div>
  <div class="card">
