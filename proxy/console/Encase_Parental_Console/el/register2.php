...
<h1>Cybersafety Family Advice Suite</h1>
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Εγγραφή Παιδιού</p>

    <?php
    if (isset($_SESSION["parent_id"])) {?>
    <form action="dist/php/newkid.php" method="post" id="form1">
 <label>Όνομα Παιδιού:<span>*</span></label>
...
<label>Σύνδεσμος Twitter Παιδιού(Twitter URL) :<span>*</span></label>
...
<center> <input name="pass" type="Password" value="<?php echo $password; ?>" style="display: none" class="input-field form-control" placeholder="*****" />
