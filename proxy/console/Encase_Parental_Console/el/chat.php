<?php
  session_start();
include('../variable_settings/vars.php'); include('head.php');
include('menu.php');
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Συνομιλίες στο Facebook για <?php echo $json_child['child_first_name'] ?>
        </h1>
        <?php
...
//            </div>';
      ...
      // End of Check if the father can see the Chat !
            ...
            echo ' <!-- Left col --><section class="col-lg-7 connectedSortable"> O/H '.$json_child['child_first_name'].' δεν έχει συμφωνήσει για να μπορείτε να δείτε τις συνομιλίες</section>';
