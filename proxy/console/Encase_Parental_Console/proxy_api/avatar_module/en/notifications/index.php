...
<head>
    ...
    <title>Notifications <?= $fb_url ?></title>
...
<div class="container mt-5">
            ...
            <div class="author-card pb-3">
                ...
                <div class="author-card-profile">
                    ...
                    <div class="author-card-details">
                        <h5 class="author-card-name text-lg">Hello! From this page you can see all the Cybersafety Family Advice Suite's notifications!</h5><span class="author-card-position">From the menu below, you can choose for which online social network (Facebook or Twitter), you want to see the notifications!</span>
                    </div>
                </div>
            </div>
            <div class="wizard">
  ...
  <div class="card">
   ...
   <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
      <div class="card-body">
       <button class="bt1" id="toggle-collapse-fb">Show older notifications</button>
  ...
  <div class="card">
    ...
    <div id="collapseTwo" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
      <div class="card-body">
       <button class="bt2" id="toggle-collapse-tw">Show older notifications</button>
      </div>
    </div>
  </div>
</div>
